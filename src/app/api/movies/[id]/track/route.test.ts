...
const req = (body: unknown) =>
  new Request('http://localhost/api/movies/catalog-1/track', {
    method: 'POST',
    body: JSON.stringify(body),
  });

describe('/api/movies/[id]/track', () => {
  ...
  it('POST tracks the item and answers 201', async () => {
    ...
    expect(mocks.apiFetch).toHaveBeenCalledWith('/v1/users/me/movies/catalog-1', {
      method: 'POST',
