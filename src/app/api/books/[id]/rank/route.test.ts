...
const put = (body: unknown) =>
  PUT(
    new Request('http://localhost/api/books/catalog-1/rank', {
      method: 'PUT',
...
describe('PUT /api/books/[id]/rank', () => {
  ...
  it('places the item at the requested position', async () => {
    ...
    expect(mocks.apiFetch).toHaveBeenCalledWith('/v1/users/me/books/catalog-1/rank', {
      method: 'PUT',
      body: { position: 3 },
    });
