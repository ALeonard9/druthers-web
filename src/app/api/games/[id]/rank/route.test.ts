...
const put = (body: unknown) =>
  PUT(
    new Request('http://localhost/api/games/catalog-1/rank', {
      method: 'PUT',
...
describe('PUT /api/games/[id]/rank', () => {
  ...
  it('places the item at the requested position', async () => {
    ...
    expect(mocks.apiFetch).toHaveBeenCalledWith('/v1/users/me/games/catalog-1/rank', {
      method: 'PUT',
      body: { position: 3 },
    });
