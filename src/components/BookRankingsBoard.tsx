...
// Always-present drop target for "#1" — the only way to place a book when
    ...
    >
      ...
      <div className="ml-auto flex shrink-0 items-center justify-end gap-2">
        ...
        <button
          ...
          aria-label={`Remove ${item.book.title} from rankings`}
...
export function BookRankingsBoard({
  ...
  async function rerank(b: UserBook) {
    ...
    router.push(`/books/ranking?item=${b.book.id}&wasRank=${b.rank}`);
  }
