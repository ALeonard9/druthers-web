...
describe('games backlog page', () => {
  ...
  it('fetches with the correct filter param on_watchlist=true', async () => {
    render(await Page({ searchParams: Promise.resolve({}) }));
    expect(mocks.apiFetch).toHaveBeenCalledWith(expect.stringContaining('?on_watchlist=true'));
  });
});
