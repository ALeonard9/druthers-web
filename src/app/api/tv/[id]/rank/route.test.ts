...
const put = (body: unknown) =>
  PUT(
    new Request('http://localhost/api/tv/catalog-1/rank', {
      method: 'PUT',
...
describe('PUT /api/tv/[id]/rank', () => {
  ...
  it('places the item at the requested position', async () => {
    ...
    expect(mocks.apiFetch).toHaveBeenCalledWith('/v1/users/me/tv-shows/catalog-1/rank', {
      method: 'PUT',
      body: { position: 3 },
    });
